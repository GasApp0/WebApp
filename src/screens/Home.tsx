    ...
    />
      ...
      <div style={{
        ...
        <div>
          ...
          }}>Select your prefer gas filling offer</p>
        </div>
        ...
        <div style={{
          ...
          <div>
            <p style={{
              fontWeight : '700',
              color : 'white'
            }}>Regular Offer (2pm to 4pm)</p>
               <p style={{
              color : '#ffffff80',
              fontSize : 12
            }}>Enjoy the convenience of having your LPG cylinder delivered to your home from 2pm to 4pm! We ensure timely deliveries so you can plan your day without any disruptions.</p>
          </div>
        </div>
